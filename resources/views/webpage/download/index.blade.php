...
[
    "og_title" => "Laden Sie den hochwertigen $song->title für Ihr Handy herunter.",
    "og_des" => "",
    "title" => "Laden Sie den hochwertigen $song->title für Ihr Handy herunter."
])
                ...
                <div class="">
                    <div class="box">
                        ...
                        <span>
                            <span>
                                ...
                                <span> <a href="/{{$category->category_slug}}">{{$category->category_name}}</a>                                    »
                                    ...
                                    <span class="breadcrumb_last" aria-current="page"> Herunterladen</span>
                                </span>
                            </span>
                        </span>
                            </p>
                        ...
                        <div class="post_container">
                            ...
                            <div class="post_head">
                                <h1 class="post_name">Klingelton {{$song->title}}</h1>
                                <script>
                                    var jQInit = jQInit || [];
...
{{--                        <span style="display:block; text-align:center;border-bottom:1px solid #ededed;margin-bottom:5px;">Advertisement</span>--}}
                ...
                <div class="download-section">
                    <div id="download-ringtone" class="overlay">
                        ...
                        <div class="popup">
                            <p class="title-report">Warten Sie, bis </p>
                            ...
                            <div class="popup-content" style="display: flex;">
                                ...
                                <div class="box-cross mb-20">
                                    <div class="bc-title">{{$song->title}} Klingelton</div>
                        ...
                        <div class="download-err">
                            <span>heruntergeladen sind,</span> <a href="{{route("dlDownload"). "?id=" .$song->id}}">klicken Sie hier!</a>
                        </div>
                    </div>
                </div>
